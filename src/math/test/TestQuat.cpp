...
GTEST(testLook)
{
    EXPECT_PRED_FORMAT2(
            ...
            qLookAt(vec3(0, 0, 0), vec3(5, 0, 0), Up()));
    EXPECT_PRED_FORMAT2(
            ::pwn::math::quat_equal_test,
            cquat(RightHandAround(Up(), Angle::FromDegrees(-90))),
            qLookAt(vec3(0, 0, 0), vec3(2, 0, 0), Up()));
    EXPECT_PRED_FORMAT2(
            ::pwn::math::quat_equal_test,
            cquat(RightHandAround(Up(), Angle::FromDegrees(-90))),
            qLookAt(vec3(0, 0, 0), vec3(0.25f, 0, 0), Up()));

    EXPECT_PRED_FORMAT2(
            ::pwn::math::quat_equal_test,
            cquat(RightHandAround(Up(), Angle::FromDegrees(180))),
            qLookInDirection(vec3(0, 0, -9), Up()));
    EXPECT_PRED_FORMAT2(
            ::pwn::math::quat_equal_test,
            cquat(RightHandAround(Up(), Angle::FromDegrees(-90))),
            qLookInDirection(vec3(3, 0, 0), Up()));
    EXPECT_PRED_FORMAT2(
            ::pwn::math::quat_equal_test,
            cquat(RightHandAround(Up(), Angle::FromDegrees(90))),
            qLookInDirection(vec3(-5, 0, 0), Up()));
...
GTEST(testCombine)
{
    EXPECT_PRED_FORMAT2(
            ::pwn::math::quat_equal_test,
            cquat(RightHandAround(Up(), Angle::FromDegrees(90))),
            Combine(cquat(RightHandAround(Up(), Angle::FromDegrees(90))),
                    qIdentity()));
...
{
    EXPECT_PRED_FORMAT2(
            ::pwn::math::axisangle_equal_test,
            RightHandAround(Up(), Angle::FromDegrees(0)),
            RightHandAround(Up(), Angle::FromDegrees(0)));
    EXPECT_PRED_FORMAT2(
            ::pwn::math::axisangle_equal_test,
            RightHandAround(Right(), Angle::FromDegrees(90)),
            RightHandAround(Right(), Angle::FromDegrees(90)));
    EXPECT_PRED_FORMAT2(
            ::pwn::math::axisangle_equal_test,
            RightHandAround(Up(), Angle::FromDegrees(-45)),
            RightHandAround(-Up(), Angle::FromDegrees(45)));
    EXPECT_PRED_FORMAT2(
            ::pwn::math::axisangle_equal_test,
            RightHandAround(Right(), Angle::FromDegrees(90)),
...
GTEST(checkAxisAngle)
{
    EXPECT_PRED_FORMAT2(
            ::pwn::math::axisangle_equal_test,
            RightHandAround(Up(), Angle::FromDegrees(0)),
            cAxisAngle(cquat(RightHandAround(Up(), Angle::FromDegrees(0)))));
    EXPECT_PRED_FORMAT2(
            ::pwn::math::axisangle_equal_test,
            RightHandAround(Right(), Angle::FromDegrees(0)),
            cAxisAngle(cquat(RightHandAround(Right(), Angle::FromDegrees(0)))));
    EXPECT_PRED_FORMAT2(
            ::pwn::math::axisangle_equal_test,
            RightHandAround(Right(), Angle::FromDegrees(90)),
            cAxisAngle(
                    cquat(RightHandAround(Right(), Angle::FromDegrees(90)))));
    EXPECT_PRED_FORMAT2(
            ::pwn::math::axisangle_equal_test,
            RightHandAround(Up(), Angle::FromDegrees(-45)),
            cAxisAngle(cquat(RightHandAround(-Up(), Angle::FromDegrees(45)))));
    EXPECT_PRED_FORMAT2(
            ::pwn::math::axisangle_equal_test,
            RightHandAround(Right(), Angle::FromDegrees(90)),
            cAxisAngle(
...
GTEST(checkQuatConjugate)
{
    ...
    const quat b =
            GetConjugate(cquat(RightHandAround(Up(), Angle::FromDegrees(-90))));
