...
namespace render
{
        ...
        : text(0)
    {
        ...
        pwnAssert_NoGLError();
        bind(0);
        const bool supportCompress =
                GLEW_ARB_texture_compression || GLEW_VERSION_1_3;
        const bool doCompress = compress && supportCompress;
        const GLint internalFormat_nc = alpha ? GL_RGBA8 : GL_RGB8;
        const GLint internalFormat_c =
                alpha ? GL_COMPRESSED_RGBA : GL_COMPRESSED_RGB;
        const GLint internalFormat =
                doCompress ? internalFormat_c : internalFormat_nc;
    ...
    void
    Texture2::bind(int position) const
    {
