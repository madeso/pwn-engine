...
namespace mesh
{
    ...
    const string
    Material::getTexture_Diffuse() const
    {
        return texture_diffuse;
    }

    void
    Material::setTexture_Diffuse(const pwn::string& v)
    {
...
#pragma warning(push)
#pragma warning(                                                               \
        disable : 4244)  // 'argument' : conversion from 'double' to 'const pwn::real', possible loss of data
