...
SUITE(testQuat)
{
	...
	TEST(checkAxisAngle)
	{
		CHECK_EQUAL(RightHandAround(Up(), Angle::FromDegrees(0)), ToAxisAngle(cquat(RightHandAround(Up(), Angle::FromDegrees(0)))));
		CHECK_EQUAL(RightHandAround(Right(), Angle::FromDegrees(0)), ToAxisAngle(cquat(RightHandAround(Right(), Angle::FromDegrees(0)))));
		CHECK_EQUAL(RightHandAround(Right(), Angle::FromDegrees(90)), ToAxisAngle(cquat(RightHandAround(Right(), Angle::FromDegrees(90)))));
		CHECK_EQUAL(RightHandAround(Up(), Angle::FromDegrees(-45)), ToAxisAngle(cquat(RightHandAround(-Up(), Angle::FromDegrees(45)))));
		CHECK_EQUAL(RightHandAround(Right(), Angle::FromDegrees(90)), ToAxisAngle(cquat(RightHandAround(-Right(), Angle::FromDegrees(-90)))));
	}
	// to axis/angle
}