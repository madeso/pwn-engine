...
namespace convert
{
    ...
    {
        bool verbose;
        explicit WriteDotCallback(bool aVerbose) : verbose(aVerbose)
        {
        }
    ...
    class InputFormat_Obj : public InputFormat
    {
    public:
        ~InputFormat_Obj()
        {
    ...
    class InputFormat_Studio3ds : public InputFormat
    {
    public:
    ...
    class InputFormat_Ms3d_ascii : public InputFormat
    {
    public:
    ...
    class InputFormat_An8 : public InputFormat
    {
    public:
        ~InputFormat_An8()
        {
    ...
    class InputFormat_Ms3d_binary : public InputFormat
    {
    public:
    ...
    const InputFormat*
    SuggestFormat(const pwn::string& ext)
    {
        if (ext == ".obj")
        {
