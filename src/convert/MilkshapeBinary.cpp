...
#pragma pack(pop)
            ...
            void
            copyToColor(Color& color, float* p)
            {
                color.r = p[0];
                color.g = p[1];
                color.b = p[2];
            ...
            public:
                ...
                readJoints()
                {
                    ...
                    for (int ji = 0; ji < jointcount; ++ji)
                    {
                        ...
                        for (int ki = 0; ki < joint.joint.numRotationKeyframes;
                             ++ki)
                        {
                        ...
                        for (int ki = 0;
                             ki < joint.joint.numTranslationKeyframes;
                             ++ki)
                        {
                            MS3DKeyframe kf = Read<MS3DKeyframe>();
            ...
            Read(BuilderList* builders, const string& meshpath)
            {
                ...
                e.animations.push_back(
                        MilkshapeCommon::ExtractAnimation(model));
