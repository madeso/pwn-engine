...
namespace engine
{
    ...
    math::vec2
    CalculateSmartMovement(const math::vec2& p, const math::vec2 s)
    {
        ...
        return math::vec2(
                dx / math::X(s),
                dy / math::Y(s));  // divide by size.y (height) as movement is measured in percenteage of window height
    }
